...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let z00 = textureLoad(previousLevel, prevCoords + vec2<i32>(0, 0), 0).r;
    let z01 = textureLoad(previousLevel, prevCoords + vec2<i32>(0, 1), 0).r;
    let z10 = textureLoad(previousLevel, prevCoords + vec2<i32>(1, 0), 0).r;
    let z11 = textureLoad(previousLevel, prevCoords + vec2<i32>(1, 1), 0).r;
